				...
				<div className={styles.place_ships}>
					...
					<div className={styles.port_box}>
						...
						<div className={styles.btn_box}>
							<Button className={'rotate_btn'} onClick={() => application.preparation.rotateShip()}></Button>
							<Button className={'general_btn'}>Авто</Button>
							<Button className={'general_btn'} onClick={() => sendShipPoints()}>
								Далее
							</Button>
						</div>
					</div>
				</div>
				{isFirstPlayer && <CopyLink url={`${process.env.REACT_APP_URL}${SHIPS_ROUTE}/${roomId}`} />}
			</div>
